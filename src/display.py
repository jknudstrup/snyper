...
class PhysicalButtonOverlay:
    ...
    def bind_physical_to_gui(self):
        ...
        # Bind A button same as other buttons (no special back behavior)
        self.keyA.release_func(self.trigger_physical_button, ('A',))
        ...
        print("🔗 Physical buttons bound: A/B/X=Configurable, Y=Sel")
